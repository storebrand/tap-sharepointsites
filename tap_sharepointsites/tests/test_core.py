...
# @pytest.MonkeyPatch.setattr(tap_sharepointsites.list_stream.ListStream.authenticator, "get_token", lambda: "token")
# def test_sync():
#     tap1 = Tapsharepointsites(config=SAMPLE_CONFIG)
#     stream1 = ListStream(
#         tap=tap1,
...
#     assert stream1.authenticator.get_token() == "token"
